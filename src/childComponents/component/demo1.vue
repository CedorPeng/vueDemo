<template>
  <div>
    ...
    <div class="dicTable" v-show="slideDownFlag">
        <form-items :formRows="formRows" refForm="formTopNew" ref="formTopNewParent" :formVal="formTop" :rules="formTopValidateNew" label-position="top"/>
    </div>
  </div>
</template>
<script>
              ...
              attr: {
                ...
                btnsOption: [
                  ...
                  { 
                    type: 'default', 
                    label: '重置',
                    clickCallback: function(){ console.log('重置') }
                  },
                  { 
                    type: 'default', 
                    label: '展开',
                    clickCallback: function(){ console.log('展开'); _this.slideDown() }
                  }
                ]
              }
            }
      ...
      btnsOption() {
        return [
                { type: 'primary', label: '查询',
                  clickCallback: function(){console.log('查询')}
                 },
